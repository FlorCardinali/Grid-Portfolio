            ...
            <div className="studies-container">
                ...
                <div className="studies-item">
                    ...
                    <div className="studies-item-text">
                        ...
                        <p className="university-description">I am currently studying to become a game designer and developer. I am learning about game design, game development, game programming, game art, game animation, game narrative and game sound design.</p>
                    </div>
                </div>
                <div className="studies-item">
                    <img src="" alt="" />
                ...
                <div className="studies-item">
                    ...
                    <div className="studies-item-text">
                        ...
                        <p className="university-description">My last two years I was an assistant in the computer lab, helping teachers and students with any computer-related issues. Also I was selected to make the model of the school's mural</p>
                    </div>
                </div>
            </div>
        </section>
